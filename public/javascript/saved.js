...
$(document).ready(function() {
    ...
    // pulling up article notes, saying article notes, and deleting article notes
    ...
    function initPage() {
        // Empty the articlew container, run an AJAX request for any saved headlines
    ...
    function renderArticles(articles) {
        ...
        // panel with our article data insie 
    ...
    function renderNotesList(data) {
        ...
        // Also setting up a currentNote variable to temporarily store eacah note
        var notesToRender = [];
        var currentNote;
    ...
    function handleNoteSave() {
        ...
        // grabbing the note typed into the inupt box
        var noteData;
